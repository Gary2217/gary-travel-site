        ...
        headers: [
          ...
          { key: 'X-DNS-Prefetch-Control', value: 'on' },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com https://cdnjs.cloudflare.com",
              "font-src 'self'",
