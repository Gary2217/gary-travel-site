...
export default function MaintenanceGuard({ children }: MaintenanceGuardProps) {
  ...
  if (status === "loading") {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#0f1923] text-white">
  ...
  if (status === "maintenance") {
    return (
      <div className="relative flex min-h-screen flex-col items-center justify-center bg-[#0f1923] px-4 text-center text-white">
        {/* 開發者入口 */}
        <button
