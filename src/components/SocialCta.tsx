...
export default function SocialCta({
  ...
  return (
    <div className={`rounded-xl border border-white/10 bg-[rgba(20,20,30,0.55)] p-5 text-center backdrop-blur-[6px] md:p-8 ${className}`.trim()}>
      <div className="mx-auto max-w-fit gap-6 md:grid md:grid-cols-[420px_720px] md:items-center md:justify-center md:gap-6">
        <div className="hidden items-center justify-center md:flex md:justify-start">
          <div className="flex h-[260px] w-full max-w-[260px] items-center justify-center p-2">
            <img src={logoUrl || "/travel-logo.svg"} alt="旅行沒有終點 LOGO" className="max-h-full max-w-full scale-110 object-contain" />
          </div>
        </div>

        <div className="relative w-full max-w-3xl overflow-hidden rounded-[1.5rem] px-2 py-3 text-left md:overflow-visible md:rounded-none md:px-0 md:py-0">
          <img
          ...
          <p className="mb-2 text-xs text-white/70 sm:text-sm md:mb-4 md:text-base">{description}</p>
          <p className="mb-3 text-[11px] font-medium leading-5 text-white sm:text-sm sm:leading-6 md:mb-4 md:text-base md:leading-7">
