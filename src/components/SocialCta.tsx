      ...
      <div className="relative mt-4">
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 flex items-center gap-2">
          <a href={fbHref} target="_blank" rel="noreferrer" aria-label="Facebook"
            className="flex h-7 w-7 items-center justify-center rounded-full border border-white/15 text-white/45 transition hover:border-[#1877F2] hover:text-[#1877F2]">
          ...
          <a href={igHref} target="_blank" rel="noreferrer" aria-label="Instagram"
            className="flex h-7 w-7 items-center justify-center rounded-full border border-white/15 text-white/45 transition hover:border-[#E4405F] hover:text-[#E4405F]">
            <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href={lineDmHref} target="_blank" rel="noreferrer" aria-label="LINE"
            className="flex h-7 w-7 items-center justify-center rounded-full border border-white/15 text-white/45 transition hover:border-[#06C755] hover:text-[#06C755]">
