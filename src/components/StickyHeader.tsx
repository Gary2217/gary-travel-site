      ...
      <div className="mx-auto flex h-full max-w-[1100px] items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <nav className="hidden items-center gap-4 sm:flex">
            ...
            <Link href="/flights" className="text-[13px] font-medium text-white/75 transition hover:text-[#48cae4]">機票</Link>
          </nav>
          ...
          <div className="flex items-center gap-1.5">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#06C755] text-white transition hover:opacity-85"
              title="LINE 諮詢"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#1877F2] text-white transition hover:opacity-85"
              title="Facebook"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#E4405F] text-white transition hover:opacity-85"
              title="Instagram"
            >
