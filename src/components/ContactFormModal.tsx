...
export default function ContactFormModal({ isOpen, onClose }: ContactFormModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-modal-top flex items-center justify-center px-4" onClick={handleClose}>
      <div className="absolute inset-0 bg-black/60 backdrop-blur-sm" />
      <div
        className="relative w-full max-w-md rounded-2xl border border-gray-200 bg-white p-4 shadow-2xl sm:p-6"
        onClick={(e) => e.stopPropagation()}
      >
        {/* 關閉按鈕 */}
        <button
          onClick={handleClose}
          className="absolute right-3 top-3 rounded-full p-1.5 text-gray-400 transition hover:bg-gray-100 hover:text-gray-900"
        >
        ...
        {submitted ? (
          ...
          <div className="py-6 text-center">
            ...
            <h3 className="text-lg font-bold text-gray-900">已送出！</h3>
            <p className="mt-2 text-sm text-gray-500">蓋瑞 Gary 會盡快跟您聯絡！</p>
            <p className="mt-1 text-xs text-gray-400">也可加 LINE 私訊蓋瑞 Gary 更快回覆您</p>
            <div className="mt-5 flex items-center justify-center gap-3">
              ...
              <button
                onClick={handleClose}
                className="rounded-lg border border-gray-200 px-5 py-2.5 text-sm font-semibold text-gray-600 transition hover:bg-gray-100 hover:text-gray-900"
              >
                關閉
              </button>
            </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p className="mt-1 text-xs text-gray-500">蓋瑞 Gary 會盡快跟您聯絡！</p>
            ...
            <div className="mt-5 space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:border-[#00b4d8] focus:ring-1 focus:ring-[#00b4d8]"
                />
              </div>

              {/* 聯繫方式提示 */}
              <p className="text-[11px] text-gray-400">以下聯繫方式請至少填寫一項</p>

              {/* 電話 */}
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-600">電話</label>
                <input
                  type="tel"
                  value={phone}
                  ...
                  className={`w-full rounded-lg border bg-gray-50 px-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:border-[#00b4d8] focus:ring-1 focus:ring-[#00b4d8] ${fieldErrors.phone ? "border-red-400/60" : "border-gray-200"}`}
                />
              ...
              {/* LINE ID */}
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-600">LINE ID</label>
                <input
                  type="text"
                  value={lineId}
                  ...
                  className={`w-full rounded-lg border bg-gray-50 px-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:border-[#00b4d8] focus:ring-1 focus:ring-[#00b4d8] ${fieldErrors.lineId ? "border-red-400/60" : "border-gray-200"}`}
                />
              ...
              {/* 信箱 */}
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-600">信箱</label>
                <input
                  type="email"
                  value={email}
                  ...
                  className={`w-full rounded-lg border bg-gray-50 px-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:border-[#00b4d8] focus:ring-1 focus:ring-[#00b4d8] ${fieldErrors.email ? "border-red-400/60" : "border-gray-200"}`}
                />
              ...
              {/* 想詢問的問題 */}
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-600">想詢問的問題</label>
                <textarea
                  value={message}
                  onChange={(e) => setMessage(e.target.value)}
                  placeholder="請簡述您想詢問的內容..."
                  rows={3}
                  className="w-full resize-none rounded-lg border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:border-[#00b4d8] focus:ring-1 focus:ring-[#00b4d8]"
                />
              </div>
            </div>
