    ...
    <>
      ...
      <div className="rounded-xl border border-white/10 bg-brand-card px-2 py-1 backdrop-blur-[12px] md:px-3 md:py-1.5">
        ...
        <div className="flex flex-col items-center gap-0.5 sm:flex-row sm:justify-center md:gap-1">
          ...
          <button
            onClick={() => copyAndOpen(fbDmHref, "Facebook", "FB")}
            className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-full bg-[#1877F2] px-4 text-xs font-semibold text-white shadow-sm transition hover:bg-[#1565d8] sm:w-auto md:h-10 md:min-w-[128px] md:px-4"
          >
          ...
          <button
            onClick={() => copyAndOpen(igDmHref, "Instagram", "IG")}
            className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-full bg-[#E4405F] px-4 text-xs font-semibold text-white shadow-sm transition hover:bg-[#d62d4a] sm:w-auto md:h-10 md:min-w-[128px] md:px-4"
          >
