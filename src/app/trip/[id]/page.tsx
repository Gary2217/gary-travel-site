                  ...
                  <div className="grid gap-4 xl:grid-cols-[0.95fr_1.2fr]">
                    <div className="space-y-4">
                      <div className="rounded-[1.25rem] border border-white/10 bg-white/5 p-4">
                        ...
                        <div className="space-y-3">
                       <div className="grid gap-2.5 lg:grid-cols-[120px_minmax(0,1fr)] lg:items-center">
                            <div className="text-xs font-semibold text-white/80">大人</div>
                            <input value={detailAdultPrice} onChange={(e) => setDetailAdultPrice(e.target.value)} placeholder="例如：100,000元起" className="w-full max-w-[300px] rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-xs text-white outline-none focus:border-sky-400" />
                          </div>
                          <div className="grid gap-2.5 lg:grid-cols-[72px_minmax(0,1fr)] lg:items-start">
                            ...
                            <div className="grid gap-2.5 sm:grid-cols-2 xl:grid-cols-3">
                              <div className="space-y-1">
                                ...
                                <input value={detailChildWithBedPrice} onChange={(e) => setDetailChildWithBedPrice(e.target.value)} className="w-full max-w-[150px] rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-xs text-white outline-none focus:border-sky-400" />
                              </div>
                              <div className="space-y-1">
                                <div className="text-xs font-semibold text-white/75">不佔床</div>
                                <input value={detailChildNoBedPrice} onChange={(e) => setDetailChildNoBedPrice(e.target.value)} className="w-full max-w-[150px] rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-xs text-white outline-none focus:border-sky-400" />
                              </div>
                              <div className="space-y-1 sm:col-span-2 xl:col-span-1">
                                <div className="text-xs font-semibold text-white/75">加床</div>
                                <input value={detailChildExtraBedPrice} onChange={(e) => setDetailChildExtraBedPrice(e.target.value)} className="w-full max-w-[150px] rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-xs text-white outline-none focus:border-sky-400" />
                              </div>
                            </div>
                          </div>
                          <div className="grid gap-2.5 lg:grid-cols-[120px_minmax(0,1.1fr)] lg:items-center">
                            ...
                            <div className="space-y-1">
                              ...
                              <input value={detailInfantPrice} onChange={(e) => setDetailInfantPrice(e.target.value)} placeholder="例如：6,000元" className="w-full max-w-[300px] rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-xs text-white outline-none focus:border-sky-400" />
                            </div>
                          </div>
                        </div>
                      </div>
