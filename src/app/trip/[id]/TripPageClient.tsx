...
export default function TripPageClient({ initialTrip }: TripPageClientProps) {
...
const [savingSourceUrl, setSavingSourceUrl] = useState(false);
  ...
  const [departureDates, setDepartureDates] = useState<DepartureDate[]>(initialTrip?.departure_dates || []);
