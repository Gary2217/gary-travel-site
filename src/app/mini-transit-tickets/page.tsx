    ...
    <main className="min-h-screen bg-transparent pt-14 text-gray-900">
      ...
      <section className="mx-auto max-w-[1520px] px-3 py-8 md:px-4">
        <div className="mb-5 rounded-[1.5rem] border border-gray-200 bg-white p-5 shadow-sm">
          <h1 className="text-2xl font-black text-gray-900">小三通票卷</h1>
          <p className="mt-2 text-sm text-gray-600">以下票券內容為站內整理，實際票價與開票規則請以顧問最新說明為準。</p>
        </div>
      ...
      {isDevMode && (
        <div className="mx-auto max-w-[1520px] px-3 pb-2 text-right text-xs text-gray-400 md:px-4">開發者模式已啟用</div>
      )}
